...
@section('main')
        <div class="d-flex mt-2 justify-content-between">
            <h3 class="order-1">Listado de Boletas</h3>
            <a href="{{ route('boleta.create') }}" class="btn btn-success order-2">Crear Boleta</a>
        </div>
        <div class="row mt-2">
            <div class="col">
                                    ...
                                    <td>
                                        <div class="d-flex flex-row-reverse">
                                            <div>
                                                ...
                                                <a href="" class="btn btn-primary pr-2" style="font-size: small" >
